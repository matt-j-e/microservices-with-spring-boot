...
public class ChallengeServiceTest {
  ...
  @Test
  public void checkUserLastAttempts() {
    // given
    ...
    // when
    List<ChallengeAttempt> userLastAttempts = challengeService.getLatestAttemptsForUser("john_doe");

    // then
    then(userLastAttempts.size()).isEqualTo(2);
    then(userLastAttempts).isEqualTo(lastAttempts);
  }
}
